...
export const RightColumn = (): JSX.Element => {
  ...
  return (
    <div className="z-10 flex flex-col flex-1 items-center justify-evenly sm:justify-center sm:gap-6 w-full text-center bg-gradient-to-br from-primary-600 via-purple-600 to-secondary-600 basis-0">
