...
export const LoginRightColumn = (): JSX.Element => {
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 flex lg:w-1/2 lg:order-2 min-h-[400px] lg:min-h-auto">
