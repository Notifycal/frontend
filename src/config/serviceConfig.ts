...
import { countryToSmsCostMapStringifiedSchema, productsInfoSchema } from '@notifycal/shared/pricing';
...
export const serviceConfigSchema = z.object({
  ...
  COUNTRY_TO_SMS_COST_MAP: countryToSmsCostMapStringifiedSchema,
